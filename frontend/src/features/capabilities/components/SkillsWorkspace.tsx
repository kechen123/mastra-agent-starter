  ...
  return (
    ...
    >
      {error && (
        <div
          role="alert"
          className="absolute z-20 top-3 left-1/2 -translate-x-1/2 max-w-[520px] py-2 px-3 text-[12.5px] text-app-danger bg-app-danger/[0.08] border border-app-danger/30 rounded-md flex items-center gap-2 shadow-lg"
        >
          ...
          <button
            ...
            className="text-[12px] font-medium underline underline-offset-2 cursor-pointer focus-visible:outline-none"
          >
            重试
          </button>
        </div>
